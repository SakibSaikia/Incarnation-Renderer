namespace RenderJob
{
	...
	concurrency::task<void> PathtraceResolve(RenderJob::Sync& jobSync, const PathtraceResolvePassDesc& passDesc)
	{
		...
		return concurrency::create_task([=]
		{
			...
			d3dCmdList->SetGraphicsRootDescriptorTable(1, RenderBackend12::GetGPUDescriptor(D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV, (uint32_t)BindlessDescriptorRange::Texture2DBegin));
