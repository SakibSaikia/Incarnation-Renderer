#define rootsig \
    ...
    "RootConstants(b0, num32BitConstants=17, visibility = SHADER_VISIBILITY_PIXEL)," \
...
float4 ps_main(vs_to_ps input) : SV_Target
{
	...
	return g_bindlessCubeTextures[g_envmapTextureIndex].Sample(g_anisoSampler, worldPos.xyz);
}